...
class CaseForm(forms.Form):
    case_num = forms.CharField(max_length=20, required=True, label='用例编号',
                               error_messages={
                                   'required': '用例编号不能为空',
                                   'invalid': '请重新输入用例编号'
                               },
    ...
    name = forms.CharField(max_length=20, required=True, label='用例标题',
                           error_messages={
                               'required': '用例标题不能为空',
                               'invalid': '请重新输入用例标题'
                           },
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['type'].widget.choices = Cases.type
        # self.fields['level'].widget.choices = Cases.level
